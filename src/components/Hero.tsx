        ...
        <div className="grid grid-cols-1 gap-8 items-center">
          <div className="space-y-8 hero-text max-w-3xl mx-auto lg:mx-0">
            ...
            <div className="animate-on-scroll opacity-0 flex flex-col sm:flex-row gap-4" style={{ animationDelay: "0.4s" }}>
              <Button asChild size="lg" className="bg-gradient-to-r from-[#555555] via-[#C8C8C9] to-[#403E43] hover:from-[#C8C8C9] hover:via-[#F1F1F1] hover:to-[#9F9EA1] text-elegant-gray-900 font-semibold border-0 h-14 px-6 text-base rounded-xl group shadow-md transition-all duration-300 animate-gradient-x">
                <Link to="/schedule">
