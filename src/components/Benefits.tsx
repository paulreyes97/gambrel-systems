        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[500px] w-full rounded-lg bg-white p-8 shadow-lg overflow-hidden">
              ...
              <div className="relative z-10 h-full flex flex-col justify-center">
                <div className="grid grid-cols-2 gap-8 my-8">
                  {[
                    { icon: Clock, label: "Save Time", color: "text-blue-500", bg: "bg-blue-100" },
                    { icon: DollarSign, label: "Cut Costs", color: "text-green-500", bg: "bg-green-100" },
                    { icon: Target, label: "Enhance Efficiency", color: "text-red-500", bg: "bg-red-100" },
                    { icon: Eye, label: "Improve Visibility", color: "text-purple-500", bg: "bg-purple-100" },
                  ].map((item, i) => {
          ...
          <div className="space-y-8 order-1 lg:order-2">
            ...
            <div className="space-y-6">
              {[
                { text: "Custom AI solutions designed for your specific operational needs", icon: Target },
                { text: "Reduce manual processes and streamline project timelines", icon: Clock },
                { text: "Lower operational costs through intelligent automation", icon: DollarSign },
                { text: "Enhanced project visibility with real-time insights", icon: Eye },
                { text: "Improved compliance and safety monitoring", icon: ShieldCheck },
                { text: "Integration with your existing systems and workflows", icon: ArrowRight }
              ].map((benefit, index) => {
